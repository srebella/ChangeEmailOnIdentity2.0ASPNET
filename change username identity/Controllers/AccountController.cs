...
using change_username_identity.Models;

namespace change_username_identity.Controllers
{
    [Authorize]
        ...
        public async Task<ActionResult> ChangeEmail(ChangeEmailViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string callbackUrl = await UserManager.GenerateEmailConfirmationTokenAsync(userId);
